...
```
As a user,
so that I can see all of my activity on the site,
I would like to be able to view my profile page.
```
```
As a User,
...
```
As a user,
so that I can alter comments that contain errors,
I would like to be edit my comments.
```
